...
def interprete_comandos2(comando):
	if patron_chp.match(comando):
		print "CHAT PRIVADO"
		arr=comando.split("@")
		return "CPri",arr[1]

	if patron_chg.match(comando):
		print "CHAT GLOBAL"
		return "CGlo",""
...
def enviarMensaje(cliente,cliente_destino,msg):
        ...
        cliente.conn.sendall('\033[1;31;40m'+reply)
    ...
    while activo:
        ...
        if has_nickname==False:
            ...
            if modo_chat_privado==False and modo_chat_publico==False:
                ...
                mod=interprete_comandos2(msg_entrada)
                reply=""
            ...
            if modo_chat_privado==False and modo_chat_publico==False:
                ...
                reply="\033[1;34;40m SERVIDOR..OK\n"
                conn.sendall(reply)
